    ...
    <>
      ...
      <h1 className="sectionHeading">Navigating the site</h1>
        ...
        <div className="sectionBlock">
          ...
          <p> This website was designed to look good on any device, meaning you can view it on a computer, phone, tablet, or even a smart-toaster, if you have one with a screen. If you want, you cause use ctrl-M to resize the page to your desire.</p>
        </div>
    </>
  )
}
